...
<Figure
  height="424"
  width="475"
  src="/images/youre-building-software-wrong/software-square.svg"
  alt="A square, with the top edge highlighted in yellow with a label of 'User Experience', and the bottom edge highlighted in blue with a label of 'Infrastructure', filled with purple squiggles and a label of 'Implementation'."
  caption="A visual model for how to think about software"
/>
...
<Figure
  height="483"
  width="662"
  src="/images/youre-building-software-wrong/horizontal-slices.svg"
  alt="The previous square diagram broken down into horizontal slices, with each slice shifted slightly left or right, resulting in a top horizontal slice being slightly off from the original expected top edge of the square, labeled as 'Resulting UX'."
  caption="Horizontal Slices"
/>
...
<Figure
  height="475"
  width="600"
  src="/images/youre-building-software-wrong/vertical-slices.svg"
  alt="The square diagram, this time split into vertical slices. Each slice has a slightly different width, and has different highlighted sections for the top edge of the square. With a label reading 'Each slice delivers incremental value'."
  caption="Vertical Slices"
/>
