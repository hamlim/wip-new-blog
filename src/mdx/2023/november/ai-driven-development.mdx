...
VSCode<FootnoteRef id="1">I do wonder if that opinion would have changed had I start using it in a language that I don’t know as well, such as Go lang.</FootnoteRef>.
...
<Footnote id="1">I do wonder if that opinion would have changed had I start using it in a language that I don’t know as well, such as Go lang.</Footnote>
