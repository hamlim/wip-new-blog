...
tags:
  ...
  - Teams
description: >-
  Low/no process workflow wasn't actually no process, it was only an "invisible"
  process. An implicit contract with everyone on the team to do that async
  workflow on their own time.
month: december
year: 2023
