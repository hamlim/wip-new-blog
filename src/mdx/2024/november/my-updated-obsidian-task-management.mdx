...
I previously wrote about how I started to manage my todos within Obsidian directly [within this post](/2024/july/simple-obsidian-task-management), however I've tweaked the workflow just a bit and that previous post also outlined a few open questions I had (mostly for myself) that I think I have some answers to now as well!
