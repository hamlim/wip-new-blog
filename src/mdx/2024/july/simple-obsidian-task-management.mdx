...
**Update:** I've outlined an updated workflow within [this blog post](/2024/november/my-updated-obsidian-task-management), check it out!

</Callout>

The other week I [wrote about switching back to Obsidian](/2024/july/switching-back-to-obsidian) and talked briefly about how I manage my tasks within Obsidian as well. This post is aiming to be a bit more of a deep dive on how I got to my current setup, what it is, and what are some of the still present pain points that I'm thinking about solving going forward.
