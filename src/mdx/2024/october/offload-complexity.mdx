...
tags:
  ...
  - Learning
description: >-
  A rough mental model for how you should be leveraging AI as a tool for your
  own growth
month: october
year: 2024
...
In the same way - if you as an individual offload opportunities you have to learn, grow, or excel in your own - you will miss the follow on opportunities for greater achievements. This is why we should look to leveraging AI<FootnoteRef id="1">This can be said of technology more broadly as well!</FootnoteRef> as a tool to be used in some scenarios and not in others.
...
<TLDR>Offload Complexity, Don't Offload Learning!</TLDR>
