...
Dogfooding can still be a useful exercise for attracting new users, see for example the note from [my original post](/2024/august/dogfooding) on how [Graphite](https://graphite.dev) forces their employees to go back through the account creation flow every so often by deleting their account on a scheduled basis.
