...
me to be more productive<FootnoteRef id="1">Separately I should really write up a blog post about my Slack
workflow 🤔</FootnoteRef>. I've broken these down into four
