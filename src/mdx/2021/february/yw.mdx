...
my [Navigating Monorepos with Ease](/2023/january/navigating-monorepos-with-ease)
blog post!

---

Almost a year or more ago I stumbled across this super useful bash function that
makes it incredibly easy to run scripts across a [Yarn](https://yarnpkg.com/)-based monorepo. Since then I haven't looked back,
