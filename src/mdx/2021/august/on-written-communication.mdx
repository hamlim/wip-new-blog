...
about it in writing<FootnoteRef id="1">I do however really enjoy being able to create and use emoji
that are entirely custom!</FootnoteRef>.
...
~~collaborate with~~ _think with_ teammates<FootnoteRef id="2">I'd be really curious to test this out at some point, or even
to hear from folks that have tried a similar setup to see how it's worked or not
worked!</FootnoteRef>. While
