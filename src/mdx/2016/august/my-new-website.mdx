...
show up either<FootnoteRef id="1">To combat this in the future I plan on making a snapshot branch on Github and forking those out into their separate repos (maybe).</FootnoteRef>. The version that I can find is
...
the [home page](#image1) the second is [my resume](#image2), the third is my [blog archive](#image3), and the fourth is the layout of a [blog post](#image4).


<Figure
  id="image1"
  src="/images/my-new-website/landing.png"
  alt="Landing Page"
...
<Figure
  id="image2"
  src="/images/my-new-website/resume.png"
  alt="Resume Page"
  caption="Resume page"
  width="3840"
  height="14522"
...
<Figure
  id="image3"
  src="/images/my-new-website/archive.png"
  alt="Archive Page"
...
<Figure
  id="image4"
  src="/images/my-new-website/post.png"
  alt="Blog post page"
...
<Footnote id="1">To combat this in the future I plan on making a snapshot branch on Github and forking those out into their separate repos (maybe).</Footnote>
